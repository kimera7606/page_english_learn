...
frases_200 = {
    ...
    'ESTOY BIEN AND YOU' :'I AM FINE AND YOU',
    'COMO HAS ESTADO' : 'HOW HAVE YOU BEEN',
    'BUENOS DIAS' : 'GOOD MORNING',
    'BUENAS NOCHES (DESPEDIDA)' : 'GOOD NIGTH',
    'GRACIAS' : 'THANKS YOU',
    'NO GRACIAS' : 'NO THANKS',
    'COMO TE LLAMAS' : 'WHATS IS YOUR NAME',
    'MI NOMBRE ES' : 'MY NAME IS',
    'PERDON' : 'I AM SORRY',
    'QUE ESTAS HACIENDO' : 'WHATS ARE YOU DOING',
    'QUE PIENSAS' : 'WHATS DO YOU THINK',
    'SUENA GRANDIOSO' : 'THAT SOUNDS GREAT',
    'DESCUIDA' : 'NEVER MIND',
    'ESTOY APRENDIENDO INGLES' : 'I AM LEARNING ENGLISH',
    'NO ENTIENDO' : 'I DONT UNDERSTAND',
    'UN GUSTO CONOCERTE' : 'NICE TO MEET YOU',
    'ADIOS' : 'BYE',
    'TEN UN BUEN DIA' : 'HAVE A NICE DAY',
    'CUIDATE' : 'TAKE CARE',
    'NOS VEMOS LUEGO' : 'SEE YOU LATER',
    'NOS VEMOS PRONTO' : 'SEE YOU SOON',
    'DISCULPE' : 'EXCUSE ME',
    'DIOS MIO' : 'OH MY GOD',
    'TE VES ASOMBROSO' : 'YOU LOOK AMAZING',
    'TU TAMBIEN' : 'YOU TOO',
    'IGUALMENTE' : 'LIKEWISE',
    'QUE HERMOSO' : 'WHAT A BEAUTIFUL',
    'TE GUSTA?' : 'DO YOU LIKE IT',
    'SI ME GUSTA' : 'YES I LIKE IT',
    'ME DEBO IR' : 'I HAVE GOT TO GET GOING',
    'ME ENCANTA' : 'I LOVE IT',
    'NO ME GUSTA' : 'I DONT LIKE',
    'ODIO' : 'I HATE',
    'DISFRUTA TU COMIDA' : 'ENJOY YOUR MEAL',
    'DISCULPE, DONDE ESTA' : 'EXCUSE ME, WHERE IS',
    'NECESITO IR A' : 'I NEED TO GET TO',
    'DEJAME VERIFICAR' : 'LET ME CHECK',
    'A LA DERECHA' : 'TO THE RIGHT',
    'A LA IZQUIERDA' : 'TO THE LEFT',
    'VE DERECHO' : 'GO STRAIGTH',
    'AQUI ESTA BIEN' : 'HERE IS FINE',
    'DETENTE AQUI POR FAVOR' : 'STOP HERE PLEASE',
    'DONDE ESTA LA SALIDA' : 'WHERE IS THE EXIT',
    'DONDE ESTA LA ENTRADA' : 'WHERE IS THE ENTRANCE',
    'QUE ESTA MAL' : 'WHATS IS WRONG',
    'QUE SUCEDE' : 'WHATS THE MATTER',
    'ASUNTO' : 'MATTER',
    ...
    'CUANDO NOS VAMOS' : 'WHEN ARE WE LEAVING',
    'CUANDO LLEGAMOS' : 'WHEN ARE WE ARRIVING',
    'RECUPERATE PRONTO' : 'GET WELL SOON',
    'NO LO CREO' : 'I DONT THINK',
    'SOLO UN POCO' : 'JUST A LITTLE',
    'ESPERAME' : 'WAIT FOR ME',
    'NO ME IMPORTA' : 'I DONT CARE',
    'ME DA IGUAL' : 'I DONT MAIN',
    'LO QUIERO' : 'I WANT IT',
    ...
    'COMO SE CONOCIERON' : 'HOW DID YOU MEET EACH OTHER'
    'VIVEN JUNTOS' : 'DO YOU LIVE TOGETHER',
    'VIVO CON MIS PADRES' : 'I LIVE WHIT MY PARENTS',
    'TENGO 3 HERMANOS Y 1 HERMANA' : 'I HAVE THREE BROTHERS AND ONE SISTER',
    'TENGO 2 HIJOS' : 'I HAVE TWO CHILDRENS',
    'VIVO CERCA DE MIS PADRES' : 'I LIVE CLOSE TO MY FAMILY',
    'VIVO LEJOS DE MIS PADRES' : 'I LIVE FAR AWAY FROM MY FAMILY',
    'LOS EXTRAÑO' : 'I MISS THEM',
    'MI COMIDA FAVORITA ES' : 'MY FAVORITE FOOD IS',
    'YO NUNCA HE INTENTADO' : 'I HAVE NEVER TRY IT',
    'NO SE COMO' : 'I DONT KNOW HOW TO',
    'ES DELICIOSO' : 'ITS DELICIUS',
    'ESTOY LLENO' : 'I AM STUFFED',
    'CUAL ES TU COMIDA FAVORITA' : 'WHATS IS YOUR FAVORITE FOOD',
    'AYER' : 'YESTERDAY',
    'HACE UNA HORA' : 'A HOUR AGO',
    'LA SEMANA PASADA' : 'THE LAST WEEK',
    'EL MES PASADO' : 'THE LAST MONTH',
    'MAÑANA' : 'TOMORROW',
    'LA SIGUIENTE SEMANA' : 'THE NEXT WEEK',
    'EN UNOS CUANTOS AÑOS' : 'IN A FEW YEARS',
    'CUANDO ERA NIÑO' : 'WHEN I WAS A KID',
    'POR EJEMPLO' : 'FOR INSTANCE',
    'QUE HORA ES?' : 'WHATS TIME IS IT',
    'ESTAS BIEN ?' :'ARE YOU ALRIGTH',
    'LUCES DECAIDO' : 'YOU LOOK A BIT DONW',
    'QUE HA PASADO?' : 'WHAT HAPPENED',
    'ESO ES MUY MALO' : 'THAT IS TOO BAD',
    'QUE FASTIDIO' : 'WHAT A BUMMER ',
    'A QUE HORA TRABAJAS?' : 'WHAT TIME DO YOU WORK',
    ...
    'COMO ESTA EL CLINA' : 'WHATS DO WEATHER LIKE',
    'ESTA SOLEADO' : 'IT IS SUNNY',
    'ESTA NUBLADO' : 'IT IS CLOUDY',
    'ESTA LLUVIOSO' : 'IT IS RAINY',
    'ESTA CALUROSO' : 'IT IS HOT',
    'ESTA FRIO' : 'IT IS FREEZING',
    'TOMARE UN BUS HACIA' : 'I WILL TAKE A BUS TO',
    'YO CONDUZCO HACIA' : 'I DRIVE TO',
    'SIENTO LLEGAR TARDE' : 'SORRY I AM LATE',
    'ESTOY ABURRIDO' : 'I AM BORED',
    'ESTOY DESEPCIONADO ' : 'I AM DISAPPOINTED',
    'ESTOY CANSADO' : 'I AM TIRED',
    'TENGO SUEÑO' : 'I AM SLEEPE',
    'ESTOY EXHAUSTO' : 'I AM EXHAUSTED',
    'ESTOY DEPRIMIDO' : 'I AM DEPRESSED',
    'SOLO BROMEO' : 'JUST KIDDING',
    'SIENTO MOLESTARTE, PERO' : 'I AM SORRY TO BOTHER YOU BUT',
    'PARECE HABER UN PROBLEMA CON' : 'THERE SEEMS TO BE A PROBLEM WITH',
    'PUEDES AYUDARME POR FAVOR CON' : 'CAN YOU PLEASE HELP ME WITH',
    'PUEDES POR FAVOR DECIRME POR QUE' : 'COULD YOU PLEASE TELL ME WHY',
    'ODIO DECIRTE ESTO PERO' : 'I HATE TO TELL YOU BUT',
    'COMO TAL SI' : 'HOW ABOUT IF',
    'POR QUE NO?' : 'WHY DONT',
    'POR QUE NO LO HACES?' : 'WHY DONT YOU',
    'WHY DONT YOU REPLY' : 'PORQUE NO RESPONDES',
    'QUIZAS (TAL VEZ) DEBERIAMOS' : 'MAYBE WE SHOULD',
    'YO RECOMENTARIA' : 'I WOULD RECOMMEND',
    'HAS PENSADO EN (O SOBRE)  ...' : 'HAVE YOU THOUGHT ABOUT',
    'QUE HACES PARA TRABAJAR' : 'WHAT DO YOU DO FOR WORK',
    'ESTOY DESEMPLEADO' : 'I AM UNEMPLOYED',
    'ESTOY ENTRE TRABAJOS EN ESTE MOMENTO' : 'I AM BETWEEN AT THE MOMENT',
    'ESOTY BUSCANDO TRABAJO' :'I AM LOOKING FOR WORK',
    'SOY AMA DE CASA' : 'I AM STAY AT HOME MOM',
    'TENGO MI PROPIO NEGOCIO' : 'I RUN MY ONW BUSINESS',
    'SOY CONTRATISTA' : 'I AM FREELANCE',
    'SABES LO QUE QUIERO DECIR' : 'DO YOU KNOW WHAT I MEAN',
    'NECESITO UN POCO DE AYUDA' : 'I NEED A LITTLE HELP',
    'ME PODRIAS AYUDAR?' : 'COULD YOU HELP ME OUT',
    'DONDE ESTA EL' : 'WHERE IS HE',
    'LO ESTAS HACIENDO GRANDIOSO' : 'YOU ARE DOING GREAT',
    'NO ABANDONDES (NO TE RINDAS)' : 'DONT GIVE UP',
    'TU PUEDES HACERLO' : 'YOU CAN DO IT',
    'BUENA SUERTE' : 'GOOD LUCK',
    'MEJOR SUERTE PARA LA PROXIMA' : 'BETTER LUCK NEXT TIME',
    'NO TAN RAPIDO' : 'NOT SO FAST',
    'ME TEMO QUE' : 'I AM SCARED THAT',
    'TU ESTAS BROMENANDO' : 'ESTAS BROMEANDO',
    'ES EL UN IDIOTA' : 'HE IS AN ASSHOLE',
    'ESTAS BORRACHO' : 'ARE YOU DRUNK',
    'I AM BIT TIPSY' : 'ESTOY UN POCO ACHISPADO',
    'PONLO EN MI CUENTA' : 'PUT IN ON MY TAP',
    'YO INVITO' : 'IT IS ON ME',
    'TENGO RESACA' : 'I AM HUNGOVER',
    'NO LO PODIAS EVITAR' : "YOU COULDN'T HELP IT",
    'OLVIDALO' : 'FORGET ABOUT IT',
    'NO TE PREOCUPES POR ESO' : 'DONT WORRY ABOUT IT',
    'ESTA BIEN' : 'THAT IS ALL RIGHT',
    'NO IMPORTA' : 'IT IS DOES NOT MATTER',
    'PONERSE DE PIE (PARATE)' : 'STAND UP',
    'SIENTATE' : 'SIT DOWN',
    'CIERRA LA PUERTA' : 'CLOSE THE DOOR',
    'BUENA ESA' : 'NICE ONE'
    'NO ME IMPORTA' : 'I DONT MIND',
    'TE COMPRENDO' : 'I FEEL YOU',
    'LO ENTIENDO' : 'I GET IT',
    'CULPA MIA' : 'MY BAD',
    'APUESTO QUE SI' : 'YOU BET',
    'NO TE PREOCUPES' : 'NO WORRIES',
    'NO ES GRAN COSA' :'NO BIGGIE',
    'EL CONCIERTO ESTUVO EPICO' : 'THE CONCERT WAS EPIC',
    'LA PELICULA APESTABA' : 'THE MOVIE SUCKED',
    'ESTOY ENAMORADO DE ELLA' : 'I HAVE A CRUSH ON HER',
    'ELLA ME DEJO' : 'SHE DUMPED ME',
    'QUIERES SALIR UN RATO' : 'DO YOU WANT TO HANG OUT',
    'METETE EN TUS PROPIOS ASUNTOS' : 'MIND YOUR OWN BUSINESS',
    'DEBES ESTAR BROMEANDO' : 'YOU MOST BE JOKING',
    'DATE PRISA' : 'HURRY UP',
    'SOLO UN SEGUNDO' : 'JUST A SEC',
    'TU TURNO' : 'YOUR TURN',
    'TU VAS PRIMERO' : 'YOU GO FIRST',
    'NI LOCO' : 'HELL NO',
